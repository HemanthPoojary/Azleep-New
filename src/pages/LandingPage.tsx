        ...
        <div className="container mx-auto text-center z-10 relative">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            ...
            <Button 
              ...
              variant="outline" 
              size="lg" 
              className={`text-lg h-12 px-8 w-full md:w-auto border-white text-white hover:bg-white/10 ${isAudioPlaying ? 'bg-white/20' : ''}`}
            >
      ...
      <section className="py-16 px-4 md:px-8 bg-gradient-to-b from-[#2C3E50] to-[#1a1a2e]">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <FeatureCard
              icon={<Mic size={40} />}
              title="AI Sleep Genie"
              description="Your personal sleep coach that understands your needs and provides tailored guidance."
            />
            
            <FeatureCard
              icon={<Music size={40} />}
              title="Personalized Sleep Casts"
              description="Stories and soundscapes designed to help you fall asleep faster and sleep deeper."
            />
            
            <FeatureCard
              icon={<Heart size={40} />}
              title="Mood Tracking"
              description="Voice-based stress insights that help you understand your mental wellbeing patterns."
            />
            
            <FeatureCard
              icon={<Moon size={40} />}
              title="Late-Night Nudges"
              description="Gentle reminders to unwind and prepare for sleep at the right time."
            />
          </div>
        ...
        <div className="container mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-8 justify-center">
            <StepCard
              ...
              image="https://placeholder-url.com/browser-mockup.jpg"
            />
            ...
            <StepCard
              ...
              image="https://placeholder-url.com/microphone-image.jpg"
            />
      ...
      <section className="py-16 px-4 md:px-8 bg-gradient-to-b from-[#34323c] to-[#2C3E50]">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <TestimonialCard
              quote="Azleep's voice coach is a game-changer! I've tried many sleep apps, but this is the first one that actually understands my sleep issues."
              author="Priya, 28"
            />
            
            <TestimonialCard
              quote="Sleep casts make bedtime relaxing. The Tamil folklore stories remind me of my childhood and help me drift off peacefully every night."
              author="Arjun, 34"
            />
          </div>
        </div>
...
const SocialButton = ({ icon, url }: { icon: string; url: string }) => (
  <a 
    ...
    className="w-10 h-10 rounded-full bg-[#8E44AD] hover:bg-[#9B59B6] flex items-center justify-center transition-colors"
  >
    {icon}
  </a>
);
